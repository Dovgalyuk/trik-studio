...
{
	QByteArray command = communication::SpikeDirectCommand::formCommand(12, 0, 0, 0
			, enums::commandType::CommandTypeEnum::DIRECT_COMMAND_REPLY);
	int index = 7;
	communication::SpikeDirectCommand::addOpcode(enums::opcode::OpcodeEnum::OUTPUT_CLR_COUNT, command, index);
	communication::SpikeDirectCommand::addByteParameter(enums::daisyChainLayer::DaisyChainLayerEnum::SPIKE, command, index);
	communication::SpikeDirectCommand::addByteParameter(lowLevelPort(), command, index);
