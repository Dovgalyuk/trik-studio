...
class SpikeKitInterpreterPlugin : public QObject, public kitBase::KitPluginInterface
{
	Q_OBJECT
	Q_INTERFACES(kitBase::KitPluginInterface)
	Q_PLUGIN_METADATA(IID "spike.SpikeKitInterpreterPlugin")

public:
	SpikeKitInterpreterPlugin();
	~SpikeKitInterpreterPlugin() override;
...
private:
	...
	SpikeAdditionalPreferences *mAdditionalPreferences = nullptr;  // Transfers ownership
