...
namespace Ui
{
class SpikeDisplayWidget;
}

namespace spike {

class SpikeDisplayWidget : public twoDModel::engine::TwoDModelDisplayWidget
{
	Q_OBJECT

public:
	explicit SpikeDisplayWidget(QWidget *parent = nullptr);
	~SpikeDisplayWidget() override;
