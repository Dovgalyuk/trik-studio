...
includes(plugins/robots/common/kitBase \
		...
		qrtext \
		plugins/robots/interpeters/spikeKitInterpreter/src \
)

links(qrkernel qrutils qrtext qrgui-preferences-dialog qrgui-tool-plugin-interface \
                robots-utils robots-kit-base robots-spike-kit robots-2d-model)

win32: QMAKE_CXXFLAGS += -Wno-error=pedantic

HEADERS += \
	$$PWD/spikeAdditionalPreferences.h \
	$$PWD/spikeKitInterpreterPlugin.h \
	$$PWD/spikeDisplayWidget.h \
	...
	$$PWD/robotModel/real/parts/spikeInputDevice.h \
...
SOURCES += \
	$$PWD/spikeAdditionalPreferences.cpp \
	$$PWD/spikeKitInterpreterPlugin.cpp \
	$$PWD/spikeDisplayWidget.cpp \
	...
	$$PWD/robotModel/real/parts/spikeInputDevice.cpp \
...
FORMS += \
	$$PWD/spikeAdditionalPreferences.ui \
	$$PWD/spikeDisplayWidget.ui \

RESOURCES += \
	$$PWD/../spikeKitInterpreter.qrc \
