...
includes( \
		plugins/robots/generators/spike/spikePythonGeneratorLibrary \
		plugins/robots/generators/spike/spikeGeneratorBase \
...
links(qrkernel qrutils qrrepo robots-generator-base robots-spike-generator-base \
		robots-kit-base robots-spike-kit robots-utils robots-spike-python-generator-library \
)
