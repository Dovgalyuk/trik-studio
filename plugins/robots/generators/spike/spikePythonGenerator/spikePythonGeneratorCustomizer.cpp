...
SpikePythonGeneratorCustomizer::SpikePythonGeneratorCustomizer(const qrRepo::RepoApi &repo
...
generatorBase::GeneratorFactoryBase *SpikePythonGeneratorCustomizer::factory()
{
	return &mFactory;
}

bool SpikePythonGeneratorCustomizer::supportsSwitchUnstableToBreaks() const
{
