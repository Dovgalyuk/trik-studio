...
#include "spikePythonControlFlowValidator.h"
...
SpikePythonControlFlowValidator::SpikePythonControlFlowValidator(const qrRepo::RepoApi &repo
...
bool SpikePythonControlFlowValidator::validate(const qReal::Id &diagramId, const QString &threadId)
{
	mDiagram = diagramId;
	findInitialNode();
...
PrimaryControlFlowValidator *SpikePythonControlFlowValidator::clone()
{
	return new SpikePythonControlFlowValidator(mRepo, mErrorReporter, mCustomizer, parent());
}
