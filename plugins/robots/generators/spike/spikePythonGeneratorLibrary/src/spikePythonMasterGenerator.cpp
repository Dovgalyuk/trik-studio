...
SpikePythonMasterGenerator::SpikePythonMasterGenerator(const qrRepo::RepoApi &repo
	...
	: SpikeMasterGeneratorBase(repo, errorReporter, parserErrorReporter, robotModelManager, textLanguage
...
generatorBase::PrimaryControlFlowValidator *SpikePythonMasterGenerator::createValidator()
{
	return new SpikePythonControlFlowValidator(mRepo, mErrorReporter, *mCustomizer, this);
}
