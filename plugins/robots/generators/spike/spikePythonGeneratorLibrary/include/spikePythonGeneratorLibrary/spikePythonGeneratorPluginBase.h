...
class SpikeRobotModel;
}

namespace python {

/// Generation of Python program for SPIKE, uploading and execution of a program.
/// Uses setting "tcpServer" from RobotsInterpreter.
class SpikePythonGeneratorPluginBase : public SpikeGeneratorPluginBase
{
	Q_OBJECT
