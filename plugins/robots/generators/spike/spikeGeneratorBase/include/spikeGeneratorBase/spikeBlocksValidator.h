...
/// Checks SPIKE blocks on a diagram for some common errors.
class ROBOTS_SPIKE_GENERATOR_BASE_EXPORT SpikeBlocksValidator : public generatorBase::RobotsDiagramVisitor
{
public:
	SpikeBlocksValidator(const qrRepo::RepoApi &repo
