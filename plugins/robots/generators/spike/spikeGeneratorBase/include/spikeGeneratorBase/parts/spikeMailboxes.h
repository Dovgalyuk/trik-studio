...
class ROBOTS_SPIKE_GENERATOR_BASE_EXPORT Mailboxes : public generatorBase::TemplateParametrizedEntity
{
public:
	...
	/// Returns spike type encoding.
	QString typeToSpikeType(const QString &typeName) const;
