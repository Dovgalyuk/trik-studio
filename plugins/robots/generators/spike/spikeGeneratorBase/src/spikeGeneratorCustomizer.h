...
class SpikeGeneratorCustomizer : public generatorBase::GeneratorCustomizer
{
public:
	SpikeGeneratorCustomizer(const qrRepo::RepoApi &repo
...
private:
	SpikeGeneratorFactory mFactory;
