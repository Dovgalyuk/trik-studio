...
QByteArray SpikeDirectCommand::formCommand(int size, int messageCounter, ushort globalSize
...
void SpikeDirectCommand::addOpcode(enums::opcode::OpcodeEnum opcode, QByteArray &command, int &index)
{
...
void SpikeDirectCommand::addByteParameter(qint8 parameter, QByteArray &command, int &index)
{
	command[index++] = enums::argumentSize::ArgumentSizeEnum::BYTE;
	command[index++] = parameter & 0xFF;
}

void SpikeDirectCommand::addShortParameter(qint16 parameter, QByteArray &command, int &index)
{
...
void SpikeDirectCommand::addStringParameter(const QString &parameter, QByteArray &command, int &index)
{
...
void SpikeDirectCommand::addGlobalIndex(qint8 globalIndex, QByteArray &command, int &index)
{
