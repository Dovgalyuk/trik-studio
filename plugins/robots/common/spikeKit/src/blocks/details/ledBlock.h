...
class LedBlock : public kitBase::blocksBase::common::DeviceBlock<robotModel::parts::SpikeLed>
{
	Q_OBJECT
...
private:
	void doJob(robotModel::parts::SpikeLed &led) override;
	robotModel::parts::SpikeLedColor toLedColor(const QString &color) const;
};
