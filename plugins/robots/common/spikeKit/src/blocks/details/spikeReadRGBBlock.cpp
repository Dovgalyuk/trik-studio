...
SpikeReadRGBBlock::SpikeReadRGBBlock(RobotModelInterface &robotModel)
	: mRobotModel(robotModel)
{
}

void SpikeReadRGBBlock::run()
{
...
void SpikeReadRGBBlock::disconnectSensor()
{
