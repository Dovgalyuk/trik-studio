...
enum DaisyChainLayerEnum {
	SPIKE = 0 // The SPIKE
	, FIRST = 1 // First SPIKE in the Daisychain
	, SECOND = 2 // Second SPIKE in the Daisychain
	, THIRD = 3 // Third SPIKE in the Daisychain
};
}
...
// Buttons on the face of the SPIKE brick
