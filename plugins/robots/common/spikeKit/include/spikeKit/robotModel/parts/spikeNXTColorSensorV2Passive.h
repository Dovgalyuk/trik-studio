...
class SpikeNXTColorSensorV2Passive : public kitBase::robotModel::robotParts::VectorSensor
{
	Q_OBJECT
...
public:
	SpikeNXTColorSensorV2Passive(const kitBase::robotModel::DeviceInfo &info
