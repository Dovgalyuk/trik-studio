...
/// A enumeration of all modes available for SPIKE LED.
enum class SpikeLedColor
{
...
/// A base for all implementations of LED on the front panel of SPIKE brick.
class SpikeLed : public kitBase::robotModel::robotParts::Device
{
	Q_OBJECT
...
public:
	SpikeLed(const kitBase::robotModel::DeviceInfo &info
			, const kitBase::robotModel::PortInfo &port);

	virtual void setColor(SpikeLedColor color) = 0;
};
